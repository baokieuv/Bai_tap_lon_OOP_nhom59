...
public class Orange extends Entity {
    private final ItemID id = ItemID.ORANGE;
    private final BufferedImage[] animations;
    private int aniTick, aniIndex, aniSpeed = 15;

    public Orange(float x, float y, int width, int height, Game game) {
    ...
    private void loadAnimations(){
        BufferedImage img = LoadSave.GetSpriteAtlas(LoadSave.ORANGE_ATLAS);
