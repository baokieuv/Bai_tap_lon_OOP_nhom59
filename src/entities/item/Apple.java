...
public class Apple extends Entity {
    private final ItemID id = ItemID.APPLE;
    private final BufferedImage[] animations;
    private int aniTick, aniIndex, aniSpeed = 15;

    public Apple(float x, float y, int width, int height, Game game) {
    ...
    private void loadAnimations(){
        BufferedImage img = LoadSave.GetSpriteAtlas(LoadSave.APPLE_ATLAS);
